...
GIT_AUTH_FAILED = "{repository} authentication failed"
GIT_AUTH_FAILED_LOG_MESSAGE = "Failed to authenticate {repository_manager}"
GIT_LABEL_TOKEN_RESOURCE_NOT_FOUND = "Git Label Token Not Found"
GIT_PROJECT_FETCH_FAILED = "Unable to fetch {repository} project"
GIT_PROJECT_FETCH_FAILED_LOG_MESSAGE = "{repository} project fetch failed"
