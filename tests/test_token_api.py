...
class TestGetGitLabelByLabelEndpoint:
    """Test cases for GET /api/v1/git_tokens/{label} endpoint."""

    def test_get_git_label_by_label_success(self, client, mock_encryption_helper):
    ...
    def test_get_git_label_by_nonexistent_label(self, client):
    ...
    def test_get_git_label_by_label_database_error(self, client):
